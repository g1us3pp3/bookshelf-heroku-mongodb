...
app.config(['stateHelperProvider','$urlRouterProvider','$urlMatcherFactoryProvider',function(stateHelperProvider,$urlRouterProvider,$urlMatcherFactoryProvider) {
	...
	stateHelperProvider.state({
		...
		name: "assets",
		url: "/assets",
		templateUrl: "components/assets/assets.html",
		controller: "AssetController",
		data: { requireLogin : true }
	}).state({
		name: "assetDetails",
		url: "/assets/:id",
		templateUrl: "components/assets/asset_details.html",
...
app.controller('AssetDetailsController', AssetDetailsController);
app.controller('AddAssetController', AddAssetController);
