...
public interface ClinicService {
	...
	Asset findAssetById(int id) throws DataAccessException;
	
	Collection<Asset> findAssetByName(String name) throws DataAccessException;
	
	void saveAsset(Asset asset) throws DataAccessException;
	
	Collection<Asset> findAssets() throws DataAccessException;
