...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Autowired
    public ClinicServiceImpl(PetRepository petRepository, AssetRepository assetRepository, VetRepository vetRepository, OwnerRepository ownerRepository, VisitRepository visitRepository) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Asset findAssetById(int id) throws DataAccessException {
	...
	@Override
	public Collection<Asset> findAssetByName(String name) throws DataAccessException {
